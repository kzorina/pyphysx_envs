...
class TalosArmRobot(URDFRobot):
    def __init__(self, urdf_path="/home/kzorina/Work/example-robot-data/robots/talos_data/robots/talos_reduced.urdf",
                 mesh_path="/home/kzorina/Work", robot_pose=(0., 0.25, 0.5), **kwargs):
        super().__init__(urdf_path=urdf_path, mesh_path=mesh_path, kinematic=True)
